...
import { scrollToHash, setTransitioning, setTransitionHandler } from '../../router'
  ...
  useEffect(() => {
    ...
    setTransitionHandler((go, hash) => {
      gsap
        ...
        // La página nueva ya puede arrancar sus animaciones de entrada
        .add(() => setTransitioning(false))
